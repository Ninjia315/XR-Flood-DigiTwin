...
{
    /// <summary>
    /// Represents a sample that loads a Model from a file-picker, and uses a custom Material Mapper to create glTF2 materials, when suitable.
    /// </summary>
    public class GltfMaterialsSample : MonoBehaviour
    {
        ...
        public void LoadModel()
        {
            ...
            // Adds the appropriate glTF2 material mapper to the asset loader options
