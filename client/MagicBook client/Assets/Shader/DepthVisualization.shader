Shader "Custom/Depth Visualization"
{
    Properties
    {
        _MainTex ("Main Texture", 2D) = "white" {}
        _DepthTex ("Depth Texture", 2D) = "white" {}
        _Min ("Min", Range(0.0, 100.0)) = 0
        _Max ("Max", Range(1, 200.0)) = 1
        _DepthMultiplier ("Depth multiplier", Range(0, 10)) = 0.5
        _LogNorm ("Log normalization factor", Range(0, 1)) = 0.5
        [MaterialToggle] _Displace("Vertex displacement", Float) = 0
        [MaterialToggle] _ColorIsDepth("Is color depth", Float) = 0
        [MaterialToggle] _SwapChannels("Swap channels", Float) = 0
    }
    SubShader
    {
