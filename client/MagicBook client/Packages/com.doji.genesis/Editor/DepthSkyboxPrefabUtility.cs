...
namespace Genesis.Editor {
    ...
    public static class DepthSkyboxPrefabUtility {
        ...
        public static void CreateSkyboxPrefab(Texture2D skybox, string assetPath, string name, Vector2 range)
        {
            ...
            CreateSkyboxPrefab(skybox, assetPath, name, range, skyboxDepth);
        }

        public static void CreateSkyboxPrefab(Texture2D skybox, string assetPath, string name, Vector2 range, Texture2D skyboxDepth, bool invert=true, float scale=1f)
        {
            ...
            m.SetFloat("_InverseDepth", invert ? 1f : 0f);
