...
namespace MobfishCardboard
{
    public static class CardboardUtility
    {
        ...
        public static bool ForceSquareResolution;
        public static Vector2Int GetAdjustedScreenResolution()
        {
            if(ForceSquareResolution)
            {
                var largestResolution = Mathf.Max(Screen.width, Screen.height);
                return new Vector2Int(largestResolution, largestResolution);
            }
