Shader "Custom/WaterShader"
{
    ...
    SubShader
    {
        ...
        void vert (inout appdata_full v, out Input o)
        {
            ...
            o.uv_NormalTex1 = 1-v.texcoord.xy;
            o.uv_TurbidityTex = 1-v.texcoord.xy;
            o.uv_NoiseTex = 1-v.texcoord.xy;
            o.uv_AlphaTex = 1-v.texcoord.xy;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float surfaceDepth = (distance(_WorldSpaceCameraPos, IN.worldPos));
            ...
            float computedOpacity = lerp(1.0, _DepthOpacity, abs(surfaceDepth-depth));// * alphaFromTexture;  // Incorporating texture alpha
            o.Alpha = computedOpacity;
            
            //float alphaFromTexture = tex2D(_AlphaTex, IN.uv_AlphaTex).a;
